    ...
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-8 sm:px-8">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-sm text-zinc-500">
          ...
          (싱글 3마리 / 더블 4마리). 상대가 메가진화할지는 별도로 표시 안 하면 자동으로 최악의
          경우(메가진화했을 때)를 가정해 계산하며, 확실히 아는 경우 직접 기본형/메가진화로 지정할 수
          있습니다. 도구는 포켓몬 챔피언스에 실제로 존재하는 도구만 추천하며(구애머리띠·구애안경 등
          본가 전용 도구는 제외), 특성/도구 추천 자체는 실제 사용률 통계가 아닌 스탯 기반 일반
          추천입니다.
        </p>
